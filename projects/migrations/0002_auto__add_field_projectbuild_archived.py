...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectBuild.archived'
        db.add_column(u'projects_projectbuild', 'archived',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectBuild.archived'
        db.delete_column(u'projects_projectbuild', 'archived')
