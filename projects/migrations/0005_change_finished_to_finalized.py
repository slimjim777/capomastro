...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.Projectbuild.objects.filter(phase="FINISHED").update(phase="FINALIZED")
    ...
    models = {
        ...
        u'projects.projectbuild': {
            ...
            'build_key': ('django.db.models.fields.CharField', [], {'default': "'1f1fab1bc45447d6bfeeb9e5c0a55388'", 'max_length': '32'}),
