...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Archive.base_url'
        db.add_column(u'archives_archive', 'base_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Archive.base_url'
        db.delete_column(u'archives_archive', 'base_url')


    models = {
        u'archives.archive': {
            'Meta': {'object_name': 'Archive'},
            'base_url': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
        ...
        u'archives.archiveartifact': {
            'Meta': {'ordering': "['archived_path']", 'object_name': 'ArchiveArtifact'},
            ...
            'archived_size': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        u'projects.projectbuild': {
            ...
            'build_key': ('django.db.models.fields.CharField', [], {'default': "'125192048664415999cfe82c46bfce67'", 'max_length': '32'}),
