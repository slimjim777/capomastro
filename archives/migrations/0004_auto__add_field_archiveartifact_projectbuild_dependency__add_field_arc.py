...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArchiveArtifact.build'
        db.add_column(u'archives_archiveartifact', 'build',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jenkins.Build'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ArchiveArtifact.projectbuild_dependency'
        db.add_column(u'archives_archiveartifact', 'projectbuild_dependency',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectBuildDependency'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ArchiveArtifact.dependency'
        db.add_column(u'archives_archiveartifact', 'dependency',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Dependency'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArchiveArtifact.build'
        db.delete_column(u'archives_archiveartifact', 'build_id')

        # Deleting field 'ArchiveArtifact.projectbuild_dependency'
        db.delete_column(u'archives_archiveartifact', 'projectbuild_dependency_id')

        # Deleting field 'ArchiveArtifact.dependency'
        db.delete_column(u'archives_archiveartifact', 'dependency_id')
    ...
    models = {
        ...
        u'archives.archiveartifact': {
            ...
            'dependency': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['projects.Dependency']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'projectbuild_dependency': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['projects.ProjectBuildDependency']", 'null': 'True', 'blank': 'True'})
        },
        u'auth.group': {
        ...
        u'projects.projectbuild': {
            ...
            'build_key': ('django.db.models.fields.CharField', [], {'default': "'821cf7dab2004d689e0cc9fa19e148ed'", 'max_length': '32'}),
        ...
        u'projects.projectbuilddependency': {
            ...
            'build': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'projectbuild_dependencies'", 'null': 'True', 'to': u"orm['jenkins.Build']"}),
            'dependency': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['projects.Dependency']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'projectbuild': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'dependencies'", 'to': u"orm['projects.ProjectBuild']"})
        },
