...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Build.requested_by'
        db.add_column(u'jenkins_build', 'requested_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Build.requested_by'
        db.delete_column(u'jenkins_build', 'requested_by_id')
