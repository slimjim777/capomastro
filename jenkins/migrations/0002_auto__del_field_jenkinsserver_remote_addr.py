...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'JenkinsServer.remote_addr'
        db.delete_column(u'jenkins_jenkinsserver', 'remote_addr')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'JenkinsServer.remote_addr'
        raise RuntimeError("Cannot reverse this migration. 'JenkinsServer.remote_addr' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'JenkinsServer.remote_addr'
        db.add_column(u'jenkins_jenkinsserver', 'remote_addr',
