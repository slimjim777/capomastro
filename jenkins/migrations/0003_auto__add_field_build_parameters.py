...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Build.parameters'
        db.add_column(u'jenkins_build', 'parameters',
                      self.gf('jenkins.fields.JSONField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Build.parameters'
        db.delete_column(u'jenkins_build', 'parameters')
